\secrel{$\oplus$ \flex/\bison: \ru{типовой рецепт реализации парсера}}\secdown
...
иллюстрации воспользуемся редактором \gvim\note{сборка для \win\ доступна на
\url{http://www.vim.org/download.php\#pc}}\ и будем запускать его из скрипта
